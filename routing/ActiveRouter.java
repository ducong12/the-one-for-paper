...
public abstract class ActiveRouter extends MessageRouter {
	...
	public static final String RESPONSE_PREFIX_TWO_HOPS = "R_2_";
	...
	public Message messageTransferred(String id, DTNHost from) {
		...
		if (m.getTo() != getHost() && m.getResponseSize() > 0&&list.size()>2){
			...
			getMessage(RESPONSE_PREFIX_TWO_HOPS+m.getId()).setRequestDropped(true);
	...
	public MessageTransferAcceptPolicy getPolicy() {
		return policy;
	}
