...
public class Message implements Comparable<Message> {
	...
	private boolean requestDropped;
	private boolean requestIgnored;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		this.responseSize = 1000;
		this.requestMsg = null;
		this.requestDropped = false;
	...
	public void setRequestDropped(boolean requestDropped) {
		this.requestDropped = requestDropped;
	}
	public void setRequestIgnored(boolean requestIgnored) {
	...
	public boolean isRequestIgnored() {
	...
	protected void copyFrom(Message m) {
		...
		this.requestDropped=m.requestDropped;
		this.requestIgnored=m.requestIgnored;
