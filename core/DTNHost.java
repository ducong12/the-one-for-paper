...
public class DTNHost implements Comparable<DTNHost> {
	...
	private HashMap<DTNHost,Integer> evaluation;
	...
	public DTNHost(List<MessageListener> msgLs,
			...
			MovementModel mmProto, MessageRouter mRouterProto,String affiliation,
				   String city,String nationality,String language,
				   String country,String position) {
		this.comBus = comBus;
	...
	public HashMap<DTNHost, Integer> getEvaluation() {
		return evaluation;
	}

	public void setEvaluation(HashMap<DTNHost, Integer> evaluation) {
